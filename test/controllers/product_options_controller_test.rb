...
class ProductOptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_option" do
    assert_difference('ProductOption.count') do
      post product_options_url, params: { product_option: { description: @product_option.description, price: @product_option.price, product_id: @product_option.product_id } }
    end
  ...
  test "should update product_option" do
    patch product_option_url(@product_option), params: { product_option: { description: @product_option.description, price: @product_option.price, product_id: @product_option.product_id } }
