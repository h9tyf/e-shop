...
class SoldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sold" do
    assert_difference('Sold.count') do
      post solds_url, params: { sold: { product_option_id: @sold.product_option_id, shop_id: @sold.shop_id, user_id: @sold.user_id } }
    end
  ...
  test "should update sold" do
    patch sold_url(@sold), params: { sold: { product_option_id: @sold.product_option_id, shop_id: @sold.shop_id, user_id: @sold.user_id } }
